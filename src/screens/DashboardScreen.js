...
const DashboardScreen = ({ navigation }) => {
  ...
  const handleEditCompanySave = async () => {
    if (
      !editCompanyFormData.name.trim() ||
      !editCompanyFormData.country.trim() ||
      !editCompanyFormData.state.trim()
    ) {
  ...
  const extractVin = async (imageUri) => {
    try {
      ...
      if (yearMatch)
        setVehicleFormData((prev) => ({ ...prev, year: yearMatch[0] }));
  ...
  const handleAddVehicle = async () => {
    ...
    try {
      ...
      if (!companyData || !companyData.id) {
        Alert.alert(
          "Error",
          "Company information not found. Please complete company setup first."
        );
        return;
      }
      ...
      const vehiclePayload = {
        ...
        mileage: vehicleFormData.mileage
          ? Number(vehicleFormData.mileage)
          : null,
        odometer: vehicleFormData.odometer
          ? Number(vehicleFormData.odometer)
          : null,
      ...
      Alert.alert(
        "Error",
        e.message || "Failed to add vehicle. Please try again."
      );
    } finally {
  ...
  const handleUpdateVehicle = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        e.message || "Failed to update vehicle. Please try again."
      );
    } finally {
      setVehicleFormSaving(false);
    }
              ...
              <View style={styles.statusContainer}>
                <View
                  style={[
                    styles.statusBadge,
                    {
                      backgroundColor: userData.verified
                        ? "#00E676"
                        : "#FF6B35",
                    },
                  ]}
              ...
              <View style={styles.statusContainer}>
                <View
                  style={[
                    styles.statusBadge,
                    {
                      backgroundColor: userData.is_onboarding_complete
                        ? "#00E676"
                        : "#FF6B35",
                    },
                  ]}
            ...
            >
                      ...
                      {meterImages.map((imageUri, index) => (
                        <View key={index} style={styles.imageContainer}>
                          ...
                          <TouchableOpacity
                            style={styles.removeButton}
                            onPress={() =>
                              removeImage(imageUri, setMeterImages)
                            }
                          >
                            <Text style={styles.removeButtonText}>×</Text>
                          </TouchableOpacity>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  style={[
                    styles.modalInput,
                    vehicleFormErrors.vin && styles.inputError,
                  ]}
                ...
                {vehicleFormErrors.vin && (
                  <Text style={styles.errorText}>{vehicleFormErrors.vin}</Text>
                )}
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setVehicleFormData((prev) => ({ ...prev, color: text }))
                  }
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setVehicleFormData((prev) => ({ ...prev, make: text }))
                  }
                  placeholder="Enter asset make"
                  placeholderTextColor="#666"
                />
                <Text style={styles.helpText}>
                  For reference only - not saved to database
                </Text>
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setVehicleFormData((prev) => ({ ...prev, model: text }))
                  }
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setVehicleFormData((prev) => ({ ...prev, mileage: text }))
                  }
            ...
            <View style={styles.modalContent}>
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditCompanyFormData((prev) => ({ ...prev, name: text }))
                  }
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditCompanyFormData((prev) => ({ ...prev, state: text }))
                  }
